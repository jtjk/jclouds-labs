...
import static org.jclouds.azurecompute.arm.compute.AzureComputeServiceContextLiveTest.nameStartsWith;
...
public class AzureComputeImageExtensionLiveTest extends BaseImageExtensionLiveTest {
   ...
   public void testImageCopy() throws RunNodesException {
      ...
      final AzureComputeArmTemplateOptions options = template2.getOptions().as(AzureComputeArmTemplateOptions.class);
   ...
   public void testImageCopy2() throws RunNodesException {
      String nodeId = "jtj-251";

      String imageId = "customjtj251storageasdfffddd-osDisk.884b0c7e-6ca9-4880-b35a-4c37eb66d921.vhd";
      ...
      try {
         nodes = view.getComputeService().createNodesInGroup("cust", 1, template2);
      } finally {
         view.getComputeService().destroyNodesMatching(inGroup("cust"));
      }
