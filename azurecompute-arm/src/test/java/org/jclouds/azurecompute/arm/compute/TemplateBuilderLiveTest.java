...
@Test(groups = "live", testName = "TemplateBuilderLiveTest")
public class TemplateBuilderLiveTest extends BaseTemplateBuilderLiveTest {
   @Override
   protected Set<String> getIso3166Codes() {
      return null;
   }

   public TemplateBuilderLiveTest() {
